...
<nav>
    ...
    <div class="login-box">
        <h1>Registration</h1>
        <div class="text-box">
            <input type="text" placeholder="Enter Your Username" name="" value="">
        </div>
        <div class="text-box">
            <input type="email" placeholder="Enter Your Emanil" name="" value="">
        </div>
        <div class="text-box">
         
            <input type="password" placeholder="Enter Your Password" name="" value="">
        </div><br>
